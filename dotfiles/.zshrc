...
# STATS servers
dlfiles() { open "cifs://jpeterson:$1@cm-downloads.nas.stats.local/comm_dl_downloads"; }
dllogs() { open "cifs://jpeterson:$1@cm-downloads-iis.nas.stats.local/comm_dl_webshare/Logfiles"; }
